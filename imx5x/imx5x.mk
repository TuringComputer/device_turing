...
# render related libs. align to device/turing/proprietary/render/fsl-render.mk
PRODUCT_PACKAGES += \
	libIpuRender.so

# gpu related libs. align to device/turing/proprietary/gpu/fsl-gpu.mk
PRODUCT_PACKAGES += \
	libEGL_imx51.so					\
...
# Omx related libs, please align to device/turing/proprietary/omx/fsl-omx.mk
omx_libs :=						\
	core_register					\
	component_register				\
...
PRODUCT_COPY_FILES +=	\
	device/turing/imx5x/Dell_Dell_USB_Keyboard.kl:system/usr/keylayout/Dell_Dell_USB_Keyboard.kl

PRODUCT_COPY_FILES +=	\
	device/turing/imx5x/init.rc:root/init.rc \
